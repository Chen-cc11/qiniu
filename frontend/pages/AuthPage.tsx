    ...
    <div className="min-h-screen w-full bg-[#F0F2F5] flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md animate-fade-in">
            ...
            <div className="mb-8 flex flex-col items-center space-y-4">
                ...
                <h1 className="text-3xl font-bold text-gray-800">ModelCraft</h1>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="animated-login-button w-full py-3 text-base font-semibold text-white bg-blue-600 rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
