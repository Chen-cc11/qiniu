...
<<<<<<< HEAD
          <button 
            // 点击时，调用从 App.tsx 父组件传递过来的 onLogout 函数
            onClick={onLogout}
            className="bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-lg flex items-center space-x-2 text-sm"
          >
...
>>>>>>> ff3c9b5c5b493e8dd1e73d00d3df13a4a4e56ffb
        </div>
      </div>
    </header>
  );
